...
var app = express();
var PORT = 6500 || process.env.PORT;
var initRoutes = require('../src/routes/index').initRoutes;
var db = require('../src/db/connection').db;
        ...
        db.connect(function (err) {
            if (err) {
                ...
                app.listen(PORT, function () {
                    console.log("[OK] ProfileService started PORT: ".concat(PORT));
                });
            }
        });
        return [2 /*return*/];
